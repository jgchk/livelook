...
module.exports = {
  ...
  125: (msg) => ({ type: 'ackNotifyPrivileges', token: msg.int32() }),
  ...
  145: (msg) => ({ type: 'privateRoomOperatorAdded', room: msg.str() }),
  146: (msg) => ({ type: 'privateRoomOperatorRemoved', room: msg.str() }),
  148: (msg) => {
    let decoded = {
  ...
  1001: (msg) => ({ type: 'cantConnectToPeer', token: msg.int32() }),
}
